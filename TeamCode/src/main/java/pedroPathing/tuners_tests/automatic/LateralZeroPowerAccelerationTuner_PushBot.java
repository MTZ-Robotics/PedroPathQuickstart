 ...
 */
@Config
@Autonomous(name = "PushBot Lateral Zero Power Acceleration Tuner", group = "Automatic Tuners")
public class LateralZeroPowerAccelerationTuner_PushBot extends OpMode {
