 ...
 ***********************************************/
@Config
public class mtzConstants_ItD_pushBot {
...
// Conversions
    ...
    public static final double ticksPerInchWheelDrive = driveEfficiency * (ticksPerRevolution435 * gearReductionWheel) / (Math.PI * wheelDiameterInches);
    public static final double ticksPerInchWheelStrafe = strafeEfficiency * (ticksPerRevolution435 * gearReductionWheel) / (Math.PI * wheelDiameterInches);
    public static final double ticksPerDegreeTurnChassis = turnEfficiency * ((ticksPerRevolution435 * gearReductionWheel) / (Math.PI * wheelDiameterInches))/360;
